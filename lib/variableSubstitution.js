        ...
        for (let file of files) {
            ...
            for (let file of matchedFiles) {
                ...
                if (this.isJson(file, fileContent)) {
                    ...
                    let isJsonSubstitutionApplied = false;
                    if (jsonSubsitution.validateAvailabilityEnviromentsInJson(jsonObject, envVariableUtility_1.EnvTreeUtility.getEnvVarTree())) {
                        console.log(`validateAvailabilityEnviromentsInJson SUCCEEDED`);
                        isJsonSubstitutionApplied = jsonSubsitution.substituteJsonVariable(jsonObject, envVariableUtility_1.EnvTreeUtility.getEnvVarTree());
                    }
                    else {
